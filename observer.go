...
func NewObserver(name string, samplingInterval time.Duration, summarizerWindows []time.Duration, httpPublisher *HTTPPublisher, logger *Logger) (observer *Observer) {
	observer = &Observer{
		name:    name,
		timeNow: time.Now}
	// TODO(go1.1)
