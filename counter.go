...
func NewCounter(name string, samplingInterval time.Duration, summarizerWindows []time.Duration, httpPublisher *HTTPPublisher, logger *Logger) (counter *Counter) {
	counter = &Counter{
		name:     name,
